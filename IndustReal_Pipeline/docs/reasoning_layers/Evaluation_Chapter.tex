...
\paragraph{Goal:}
Instead of measure the graph coverage over the dataset, the goal is to check whether the validation behavior inspected in Evaluation 3 can also be followed in the graph by traversing from a step to its predicates, inferred constraints, dependency support, rule provenance, and produced-effect lifecycle.
