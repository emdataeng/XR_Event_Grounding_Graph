...
Generated at: `2026-07-05T15:24:55+02:00`
...
- `steps_only`: `D:\Code\XR_Event_Grounding_Graph\IndustReal_Pipeline\experiments\llm_guidance_ablation\outputs\responses_steps_only_od_plus_error_hints_08_assy_0_1_20260703T140405+0200_patched_20260704T130004+0200.jsonl`
- `symbolic_domain`: `D:\Code\XR_Event_Grounding_Graph\IndustReal_Pipeline\experiments\llm_guidance_ablation\outputs\responses_symbolic_domain_od_plus_error_hints_08_assy_0_1_20260703T140639+0200_patched_20260704T130004+0200.jsonl`
- `query_driven_graph`: `D:\Code\XR_Event_Grounding_Graph\IndustReal_Pipeline\experiments\query_driven_graph\outputs\responses_query_driven_graph_od_plus_error_hints_08_assy_0_1_20260703T142119+0200_patched_20260704T130004+0200.jsonl`
...
| 03 | `q09_root_component_alignment_scope` | `query_driven_graph` | `step_0` | `1 min 1.8 s - 2 min 10.9 s` | `scenario_b_troubleshooting_implicit_conditions` | `ok` | `23.783486` |
...
| 14 | `q09_root_component_alignment_scope` | `steps_only` | `step_0` | `1 min 1.8 s - 2 min 10.9 s` | `scenario_b_troubleshooting_implicit_conditions` | `ok` | `9.394859` |
...
| 33 | `q09_root_component_alignment_scope` | `symbolic_domain` | `step_0` | `1 min 1.8 s - 2 min 10.9 s` | `scenario_b_troubleshooting_implicit_conditions` | `ok` | `19.934558` |
...
| 42 | `q27_unknown_step` | `query_driven_graph` | `step_999` | `N/A` | `scenario_f_missing_evidence_controls` | `ok` | `12.028493` |
...
| 69 | `q27_unknown_step` | `symbolic_domain` | `step_999` | `N/A` | `scenario_f_missing_evidence_controls` | `ok` | `17.090691` |
...
| 83 | `q27_unknown_step` | `steps_only` | `step_999` | `N/A` | `scenario_f_missing_evidence_controls` | `ok` | `9.041646` |
