...
After running the ablation conditions and the query-driven graph condition for
the same clip and question set, generate blind human-judgement packets with the
