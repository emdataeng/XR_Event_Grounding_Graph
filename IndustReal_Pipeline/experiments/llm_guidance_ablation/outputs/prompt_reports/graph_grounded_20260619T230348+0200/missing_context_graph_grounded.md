...
Generated at: 2026-06-19T21:17:20.494595+00:00
...
Sequence context:
- previous: event_0 | Install base
- current: event_1 | Install rear chassis
- next: event_2 | Install front rear chassis pin
Nodes:
...
- N26 [Step] Step 0 [accepted]; step_id="event_0"; action_description="Install base"; status="accepted"; confidence=1.0; warning_count=0
- N27 [Step] [CURRENT] Step 1 [accepted]; step_id="event_1"; action_description="Install rear chassis"; status="accepted"; confidence=1.0; warning_count=0
- N28 [Step] Step 10 [accepted]; step_id="event_10"; action_description="Install rear wheel assy"; status="accepted"; confidence=1.0; warning_count=0
- N29 [Step] Step 2 [uncertain]; step_id="event_2"; action_description="Install front rear chassis pin"; status="uncertain"; confidence=1.0; warning_count=0
- N30 [Step] Step 5 [uncertain]; step_id="event_5"; action_description="Install rear rear chassis pin"; status="uncertain"; confidence=1.0; warning_count=0
Edges:
...
Sequence context:
- previous: event_4 | Install front chassis pin
- current: event_5 | Install rear rear chassis pin
- next: event_6 | Install front bracket
Nodes:
...
- N36 [Step] Step 4 [uncertain]; step_id="event_4"; action_description="Install front chassis pin"; status="uncertain"; confidence=1.0; warning_count=0
- N37 [Step] [CURRENT] Step 5 [uncertain]; step_id="event_5"; action_description="Install rear rear chassis pin"; status="uncertain"; confidence=1.0; warning_count=0
- N38 [Step] Step 6 [accepted]; step_id="event_6"; action_description="Install front bracket"; status="accepted"; confidence=1.0; warning_count=0
Edges:
