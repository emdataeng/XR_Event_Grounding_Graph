...
- center_step_id: step::pilot_rod_assembly::step_01
- step_hops: 1
- included_step_ids: ["step::pilot_rod_assembly::step_01", "step::pilot_rod_assembly::step_02"]
...
```text
Predicate context window:
- center_step_id: step::pilot_rod_assembly::step_05
- step_hops: 1
- included_step_ids: ["step::pilot_rod_assembly::step_04", "step::pilot_rod_assembly::step_05", "step::pilot_rod_assembly::step_06"]
...
```text
Predicate context window:
- center_step_id: step::pilot_rod_assembly::step_07
- step_hops: 1
- included_step_ids: ["step::pilot_rod_assembly::step_06", "step::pilot_rod_assembly::step_07", "step::pilot_rod_assembly::step_08"]
...
step_08: hasAction["step::pilot_rod_assembly::step_08","lubricate"] [conf=1.0]
step_08: hasTimeWindow["step::pilot_rod_assembly::step_08",566,642] [conf=1.0]
step_08: usesObject["step::pilot_rod_assembly::step_08","silver_sleeve"] [conf=1.0]
step_08: usesTool["step::pilot_rod_assembly::step_08","sponge"] [conf=1.0]
step_08: usesMaterial["step::pilot_rod_assembly::step_08","grease"] [conf=1.0]
step_08: hasRequiredCondition["step::pilot_rod_assembly::step_08","cleaned_with","rod_assembly","ethanol"] [conf=1.0]
step_08: hasRequiredCondition["step::pilot_rod_assembly::step_08","secured","sleeve","metal_rod"] [conf=1.0]
step_08: hasObservedEffect["step::pilot_rod_assembly::step_08","lubricated_with","silver_sleeve","grease"] [conf=1.0]
step_08: hasObservedEffect["step::pilot_rod_assembly::step_08","avoided_contact_with","copper_sleeve","grease"] [conf=1.0]
```
