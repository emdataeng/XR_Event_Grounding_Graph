...
```text
Retrieval policy: step_hops=1, evidence_hops=2
Graph evidence (19 nodes, 35 edges):
Nodes:
- N1 [Constraint] produces partially_inserted_in(screw, rod_holes) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_04","partially_inserted_in","screw","rod_holes"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N2 [Constraint] produces applied_to(threadlocker_loctite, screw) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_05","applied_to","threadlocker_loctite","screw"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N3 [Constraint] requires partially_inserted_in(screw, rod_holes) [supported]; kind="inferred_precondition"; name="requires"; args=["step::pilot_rod_assembly::step_05","partially_inserted_in","screw","rod_holes"]; support_status="supported"; rule_id="precondition_required_pilot_condition"; confidence=1.0
- N4 [Constraint] requires applied_to(threadlocker_loctite, screw) [supported]; kind="inferred_precondition"; name="requires"; args=["step::pilot_rod_assembly::step_06","applied_to","threadlocker_loctite","screw"]; support_status="supported"; rule_id="precondition_required_pilot_condition"; confidence=1.0
- N5 [Entity] rod_holes
- N6 [Entity] screw
- N7 [Entity] threadlocker_loctite
- N8 [Predicate] hasAction(step_05, apply); name="hasAction"; args=["step::pilot_rod_assembly::step_05","apply"]; confidence=1.0
- N9 [Predicate] hasObservedEffect(step_05, applied_to, threadlocker_loctite, screw); name="hasObservedEffect"; args=["step::pilot_rod_assembly::step_05","applied_to","threadlocker_loctite","screw"]; confidence=1.0
- N10 [Predicate] usesMaterial(step_05, threadlocker_loctite); name="usesMaterial"; args=["step::pilot_rod_assembly::step_05","threadlocker_loctite"]; confidence=1.0
- N11 [Predicate] usesObject(step_05, screw); name="usesObject"; args=["step::pilot_rod_assembly::step_05","screw"]; confidence=1.0
- N12 [Predicate] hasRequiredCondition(step_05, partially_inserted_in, screw, rod_holes); name="hasRequiredCondition"; args=["step::pilot_rod_assembly::step_05","partially_inserted_in","screw","rod_holes"]; confidence=1.0
- N13 [Predicate] hasTimeWindow(step_05, 376, 429); name="hasTimeWindow"; args=["step::pilot_rod_assembly::step_05",376,429]; confidence=1.0
- N14 [Rule] effect_observed_pilot_condition; rule_id="effect_observed_pilot_condition"
- N15 [Rule] precondition_required_pilot_condition; rule_id="precondition_required_pilot_condition"
- N16 [Source] manual_symbolic_annotation:rod_assembly_steps.json
- N17 [Step] Step 4 [accepted]; step_id="step::pilot_rod_assembly::step_04"; action_description="The operator drives the screws halfway into all holes using a power screwdriver."; status="accepted"; confidence=1.0; warning_count=0
- N18 [Step] [CURRENT] Step 5 [accepted]; step_id="step::pilot_rod_assembly::step_05"; action_description="The operator applies threadlocker (Loctite) to all partially inserted screws."; status="accepted"; confidence=1.0; warning_count=0
- N19 [Step] Step 6 [uncertain]; step_id="step::pilot_rod_assembly::step_06"; action_description="The operator fully tightens all screws to secure the sleeves."; status="uncertain"; confidence=1.0; warning_count=0
Edges:
- N18<Step:step::pilot_rod_assembly::step_05> -[DEPENDS_ON]-> N17<Step:step::pilot_rod_assembly::step_04>; required_condition={"args":["screw","rod_holes"],"name":"partially_inserted_in"}; supporting_effect={"condition":{"args":["screw","rod_holes"],"name":"partially_inserted_in"},"producer_status":"accepted","provisional":false,"step_id":"step::pilot_rod_assembly::step_04","type":"previous_produced_effect"}; confidence=1.0; provisional=false
- N19<Step:step::pilot_rod_assembly::step_06> -[DEPENDS_ON]-> N18<Step:step::pilot_rod_assembly::step_05>; required_condition={"args":["threadlocker_loctite","screw"],"name":"applied_to"}; supporting_effect={"condition":{"args":["threadlocker_loctite","screw"],"name":"applied_to"},"producer_status":"accepted","provisional":false,"step_id":"step::pilot_rod_assembly::step_05","type":"previous_produced_effect"}; confidence=1.0; provisional=false
- N2 -[DERIVED_FROM]-> N14
- N3 -[DERIVED_FROM]-> N15
- N8 -[DERIVED_FROM]-> N16
- N9 -[DERIVED_FROM]-> N16
- N10 -[DERIVED_FROM]-> N16
- N11 -[DERIVED_FROM]-> N16
- N12 -[DERIVED_FROM]-> N16
- N13 -[DERIVED_FROM]-> N16
- N18 -[HAS_CONSTRAINT]-> N2
- N18 -[HAS_CONSTRAINT]-> N3
- N2 -[HAS_ENTITY]-> N6
- N2 -[HAS_ENTITY]-> N7
- N3 -[HAS_ENTITY]-> N5
- N3 -[HAS_ENTITY]-> N6
...
- N12 -[HAS_ENTITY]-> N5
- N12 -[HAS_ENTITY]-> N6
- N18 -[HAS_PREDICATE]-> N8
- N18 -[HAS_PREDICATE]-> N9
- N18 -[HAS_PREDICATE]-> N10
- N18 -[HAS_PREDICATE]-> N11
- N18 -[HAS_PREDICATE]-> N12
- N18 -[HAS_PREDICATE]-> N13
- N17<Step:step::pilot_rod_assembly::step_04> -[NEXT]-> N18<Step:step::pilot_rod_assembly::step_05>
- N18<Step:step::pilot_rod_assembly::step_05> -[NEXT]-> N19<Step:step::pilot_rod_assembly::step_06>
- N18 -[PRODUCES]-> N2
- N18 -[REQUIRES]-> N3
- N3 -[SUPPORTED_BY]-> N1
- N4 -[SUPPORTED_BY]-> N2
...
```text
Retrieval policy: step_hops=1, evidence_hops=2
Graph evidence (25 nodes, 47 edges):
Nodes:
- N1 [Constraint] produces secured(sleeve, metal_rod) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_06","secured","sleeve","metal_rod"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N2 [Constraint] produces cleaned_with(rod_assembly, ethanol) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_07","cleaned_with","rod_assembly","ethanol"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N3 [Constraint] produces avoided_contact_with(copper_sleeve, paper) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_07","avoided_contact_with","copper_sleeve","paper"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N4 [Constraint] requires secured(sleeve, metal_rod) [supported]; kind="inferred_precondition"; name="requires"; args=["step::pilot_rod_assembly::step_07","secured","sleeve","metal_rod"]; support_status="supported"; rule_id="precondition_required_pilot_condition"; confidence=1.0
- N5 [Constraint] requires cleaned_with(rod_assembly, ethanol) [supported]; kind="inferred_precondition"; name="requires"; args=["step::pilot_rod_assembly::step_08","cleaned_with","rod_assembly","ethanol"]; support_status="supported"; rule_id="precondition_required_pilot_condition"; confidence=1.0
- N6 [Entity] copper_sleeve
- N7 [Entity] ethanol
- N8 [Entity] metal_rod
- N9 [Entity] paper
- N10 [Entity] rod_assembly
- N11 [Entity] sleeve
- N12 [Predicate] hasAction(step_07, clean); name="hasAction"; args=["step::pilot_rod_assembly::step_07","clean"]; confidence=1.0
- N13 [Predicate] hasObservedEffect(step_07, avoided_contact_with, copper_sleeve, paper); name="hasObservedEffect"; args=["step::pilot_rod_assembly::step_07","avoided_contact_with","copper_sleeve","paper"]; confidence=1.0
- N14 [Predicate] hasObservedEffect(step_07, cleaned_with, rod_assembly, ethanol); name="hasObservedEffect"; args=["step::pilot_rod_assembly::step_07","cleaned_with","rod_assembly","ethanol"]; confidence=1.0
- N15 [Predicate] usesMaterial(step_07, ethanol); name="usesMaterial"; args=["step::pilot_rod_assembly::step_07","ethanol"]; confidence=1.0
- N16 [Predicate] usesMaterial(step_07, paper); name="usesMaterial"; args=["step::pilot_rod_assembly::step_07","paper"]; confidence=1.0
- N17 [Predicate] usesObject(step_07, rod_assembly); name="usesObject"; args=["step::pilot_rod_assembly::step_07","rod_assembly"]; confidence=1.0
- N18 [Predicate] hasRequiredCondition(step_07, secured, sleeve, metal_rod); name="hasRequiredCondition"; args=["step::pilot_rod_assembly::step_07","secured","sleeve","metal_rod"]; confidence=1.0
- N19 [Predicate] hasTimeWindow(step_07, 531, 566); name="hasTimeWindow"; args=["step::pilot_rod_assembly::step_07",531,566]; confidence=1.0
- N20 [Rule] effect_observed_pilot_condition; rule_id="effect_observed_pilot_condition"
- N21 [Rule] precondition_required_pilot_condition; rule_id="precondition_required_pilot_condition"
- N22 [Source] manual_symbolic_annotation:rod_assembly_steps.json
- N23 [Step] Step 6 [uncertain]; step_id="step::pilot_rod_assembly::step_06"; action_description="The operator fully tightens all screws to secure the sleeves."; status="uncertain"; confidence=1.0; warning_count=0
- N24 [Step] [CURRENT] Step 7 [accepted]; step_id="step::pilot_rod_assembly::step_07"; action_description="The operator cleans the rod and sleeves with ethanol and paper."; status="accepted"; confidence=1.0; warning_count=0
- N25 [Step] Step 8 [accepted]; step_id="step::pilot_rod_assembly::step_08"; action_description="The operator applies grease to a sponge and lubricates the silver-colored sleeves, while avoiding the copper sleeves."; status="accepted"; confidence=1.0; warning_count=0
Edges:
- N24<Step:step::pilot_rod_assembly::step_07> -[DEPENDS_ON]-> N23<Step:step::pilot_rod_assembly::step_06>; required_condition={"args":["sleeve","metal_rod"],"name":"secured"}; supporting_effect={"condition":{"args":["sleeve","metal_rod"],"name":"secured"},"producer_status":"uncertain","provisional":true,"step_id":"step::pilot_rod_assembly::step_06","type":"previous_produced_effect"}; confidence=1.0; provisional=true
- N25<Step:step::pilot_rod_assembly::step_08> -[DEPENDS_ON]-> N24<Step:step::pilot_rod_assembly::step_07>; required_condition={"args":["rod_assembly","ethanol"],"name":"cleaned_with"}; supporting_effect={"condition":{"args":["rod_assembly","ethanol"],"name":"cleaned_with"},"producer_status":"accepted","provisional":false,"step_id":"step::pilot_rod_assembly::step_07","type":"previous_produced_effect"}; confidence=1.0; provisional=false
- N2 -[DERIVED_FROM]-> N20
- N3 -[DERIVED_FROM]-> N20
- N4 -[DERIVED_FROM]-> N21
- N12 -[DERIVED_FROM]-> N22
- N13 -[DERIVED_FROM]-> N22
- N14 -[DERIVED_FROM]-> N22
- N15 -[DERIVED_FROM]-> N22
- N16 -[DERIVED_FROM]-> N22
- N17 -[DERIVED_FROM]-> N22
- N18 -[DERIVED_FROM]-> N22
- N19 -[DERIVED_FROM]-> N22
- N24 -[HAS_CONSTRAINT]-> N2
- N24 -[HAS_CONSTRAINT]-> N3
- N24 -[HAS_CONSTRAINT]-> N4
- N2 -[HAS_ENTITY]-> N7
- N2 -[HAS_ENTITY]-> N10
- N3 -[HAS_ENTITY]-> N6
- N3 -[HAS_ENTITY]-> N9
...
- N18 -[HAS_ENTITY]-> N8
- N18 -[HAS_ENTITY]-> N11
- N24 -[HAS_PREDICATE]-> N12
- N24 -[HAS_PREDICATE]-> N13
- N24 -[HAS_PREDICATE]-> N14
- N24 -[HAS_PREDICATE]-> N15
- N24 -[HAS_PREDICATE]-> N16
- N24 -[HAS_PREDICATE]-> N17
- N24 -[HAS_PREDICATE]-> N18
- N24 -[HAS_PREDICATE]-> N19
- N23<Step:step::pilot_rod_assembly::step_06> -[NEXT]-> N24<Step:step::pilot_rod_assembly::step_07>
- N24<Step:step::pilot_rod_assembly::step_07> -[NEXT]-> N25<Step:step::pilot_rod_assembly::step_08>
- N24 -[PRODUCES]-> N2
- N24 -[PRODUCES]-> N3
- N24 -[REQUIRES]-> N4
- N4 -[SUPPORTED_BY]-> N1
...
```text
Retrieval policy: step_hops=1, evidence_hops=2
Graph evidence (29 nodes, 56 edges):
Nodes:
- N1 [Constraint] produces secured(sleeve, metal_rod) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_06","secured","sleeve","metal_rod"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N2 [Constraint] produces cleaned_with(rod_assembly, ethanol) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_07","cleaned_with","rod_assembly","ethanol"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N3 [Constraint] produces lubricated_with(silver_sleeve, grease) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_08","lubricated_with","silver_sleeve","grease"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N4 [Constraint] produces avoided_contact_with(copper_sleeve, grease) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_08","avoided_contact_with","copper_sleeve","grease"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N5 [Constraint] requires cleaned_with(rod_assembly, ethanol) [supported]; kind="inferred_precondition"; name="requires"; args=["step::pilot_rod_assembly::step_08","cleaned_with","rod_assembly","ethanol"]; support_status="supported"; rule_id="precondition_required_pilot_condition"; confidence=1.0
- N6 [Constraint] requires secured(sleeve, metal_rod) [supported]; kind="inferred_precondition"; name="requires"; args=["step::pilot_rod_assembly::step_08","secured","sleeve","metal_rod"]; support_status="supported"; rule_id="precondition_required_pilot_condition"; confidence=1.0
- N7 [Entity] copper_sleeve
- N8 [Entity] ethanol
- N9 [Entity] grease
- N10 [Entity] metal_rod
- N11 [Entity] rod_assembly
- N12 [Entity] silver_sleeve
- N13 [Entity] sleeve
- N14 [Entity] sponge
- N15 [Predicate] hasAction(step_08, lubricate); name="hasAction"; args=["step::pilot_rod_assembly::step_08","lubricate"]; confidence=1.0
- N16 [Predicate] hasObservedEffect(step_08, avoided_contact_with, copper_sleeve, grease); name="hasObservedEffect"; args=["step::pilot_rod_assembly::step_08","avoided_contact_with","copper_sleeve","grease"]; confidence=1.0
- N17 [Predicate] hasObservedEffect(step_08, lubricated_with, silver_sleeve, grease); name="hasObservedEffect"; args=["step::pilot_rod_assembly::step_08","lubricated_with","silver_sleeve","grease"]; confidence=1.0
- N18 [Predicate] usesMaterial(step_08, grease); name="usesMaterial"; args=["step::pilot_rod_assembly::step_08","grease"]; confidence=1.0
- N19 [Predicate] usesObject(step_08, silver_sleeve); name="usesObject"; args=["step::pilot_rod_assembly::step_08","silver_sleeve"]; confidence=1.0
- N20 [Predicate] hasRequiredCondition(step_08, cleaned_with, rod_assembly, ethanol); name="hasRequiredCondition"; args=["step::pilot_rod_assembly::step_08","cleaned_with","rod_assembly","ethanol"]; confidence=1.0
- N21 [Predicate] hasRequiredCondition(step_08, secured, sleeve, metal_rod); name="hasRequiredCondition"; args=["step::pilot_rod_assembly::step_08","secured","sleeve","metal_rod"]; confidence=1.0
- N22 [Predicate] hasTimeWindow(step_08, 566, 642); name="hasTimeWindow"; args=["step::pilot_rod_assembly::step_08",566,642]; confidence=1.0
- N23 [Predicate] usesTool(step_08, sponge); name="usesTool"; args=["step::pilot_rod_assembly::step_08","sponge"]; confidence=1.0
- N24 [Rule] effect_observed_pilot_condition; rule_id="effect_observed_pilot_condition"
- N25 [Rule] precondition_required_pilot_condition; rule_id="precondition_required_pilot_condition"
- N26 [Source] manual_symbolic_annotation:rod_assembly_steps.json
- N27 [Step] Step 6 [uncertain]; step_id="step::pilot_rod_assembly::step_06"; action_description="The operator fully tightens all screws to secure the sleeves."; status="uncertain"; confidence=1.0; warning_count=0
- N28 [Step] Step 7 [accepted]; step_id="step::pilot_rod_assembly::step_07"; action_description="The operator cleans the rod and sleeves with ethanol and paper."; status="accepted"; confidence=1.0; warning_count=0
- N29 [Step] [CURRENT] Step 8 [accepted]; step_id="step::pilot_rod_assembly::step_08"; action_description="The operator applies grease to a sponge and lubricates the silver-colored sleeves, while avoiding the copper sleeves."; status="accepted"; confidence=1.0; warning_count=0
Edges:
- N29<Step:step::pilot_rod_assembly::step_08> -[DEPENDS_ON]-> N27<Step:step::pilot_rod_assembly::step_06>; required_condition={"args":["sleeve","metal_rod"],"name":"secured"}; supporting_effect={"condition":{"args":["sleeve","metal_rod"],"name":"secured"},"producer_status":"uncertain","provisional":true,"step_id":"step::pilot_rod_assembly::step_06","type":"previous_produced_effect"}; confidence=1.0; provisional=true
- N29<Step:step::pilot_rod_assembly::step_08> -[DEPENDS_ON]-> N28<Step:step::pilot_rod_assembly::step_07>; required_condition={"args":["rod_assembly","ethanol"],"name":"cleaned_with"}; supporting_effect={"condition":{"args":["rod_assembly","ethanol"],"name":"cleaned_with"},"producer_status":"accepted","provisional":false,"step_id":"step::pilot_rod_assembly::step_07","type":"previous_produced_effect"}; confidence=1.0; provisional=false
- N3 -[DERIVED_FROM]-> N24
- N4 -[DERIVED_FROM]-> N24
- N5 -[DERIVED_FROM]-> N25
- N6 -[DERIVED_FROM]-> N25
- N15 -[DERIVED_FROM]-> N26
- N16 -[DERIVED_FROM]-> N26
- N17 -[DERIVED_FROM]-> N26
- N18 -[DERIVED_FROM]-> N26
- N19 -[DERIVED_FROM]-> N26
- N20 -[DERIVED_FROM]-> N26
- N21 -[DERIVED_FROM]-> N26
- N22 -[DERIVED_FROM]-> N26
- N23 -[DERIVED_FROM]-> N26
- N29 -[HAS_CONSTRAINT]-> N3
- N29 -[HAS_CONSTRAINT]-> N4
- N29 -[HAS_CONSTRAINT]-> N5
- N29 -[HAS_CONSTRAINT]-> N6
- N3 -[HAS_ENTITY]-> N9
- N3 -[HAS_ENTITY]-> N12
- N4 -[HAS_ENTITY]-> N7
- N4 -[HAS_ENTITY]-> N9
...
- N21 -[HAS_ENTITY]-> N13
- N23 -[HAS_ENTITY]-> N14
- N29 -[HAS_PREDICATE]-> N15
- N29 -[HAS_PREDICATE]-> N16
- N29 -[HAS_PREDICATE]-> N17
- N29 -[HAS_PREDICATE]-> N18
- N29 -[HAS_PREDICATE]-> N19
- N29 -[HAS_PREDICATE]-> N20
- N29 -[HAS_PREDICATE]-> N21
- N29 -[HAS_PREDICATE]-> N22
- N29 -[HAS_PREDICATE]-> N23
- N28<Step:step::pilot_rod_assembly::step_07> -[NEXT]-> N29<Step:step::pilot_rod_assembly::step_08>
- N29 -[PRODUCES]-> N3
- N29 -[PRODUCES]-> N4
- N29 -[REQUIRES]-> N5
- N29 -[REQUIRES]-> N6
