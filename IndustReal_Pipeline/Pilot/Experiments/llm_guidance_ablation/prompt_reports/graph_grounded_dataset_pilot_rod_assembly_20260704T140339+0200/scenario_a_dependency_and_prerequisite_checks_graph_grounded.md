...
Graph evidence (16 nodes, 33 edges):
Nodes:
- N1 [Constraint] produces on(metal_rod, workbench) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_01","on","metal_rod","workbench"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N2 [Constraint] produces secured(metal_rod, workbench) [observed]; kind="expected_effect"; name="produces"; args=["step::pilot_rod_assembly::step_01","secured","metal_rod","workbench"]; support_status="observed"; rule_id="effect_observed_pilot_condition"; confidence=1.0
- N3 [Constraint] requires secured(metal_rod, workbench) [supported]; kind="inferred_precondition"; name="requires"; args=["step::pilot_rod_assembly::step_02","secured","metal_rod","workbench"]; support_status="supported"; rule_id="precondition_required_pilot_condition"; confidence=1.0
- N4 [Entity] metal_rod
- N5 [Entity] workbench
- N6 [Predicate] hasAction(step_01, place); name="hasAction"; args=["step::pilot_rod_assembly::step_01","place"]; confidence=1.0
- N7 [Predicate] hasObservedEffect(step_01, on, metal_rod, workbench); name="hasObservedEffect"; args=["step::pilot_rod_assembly::step_01","on","metal_rod","workbench"]; confidence=1.0
- N8 [Predicate] hasObservedEffect(step_01, secured, metal_rod, workbench); name="hasObservedEffect"; args=["step::pilot_rod_assembly::step_01","secured","metal_rod","workbench"]; confidence=1.0
- N9 [Predicate] usesObject(step_01, metal_rod); name="usesObject"; args=["step::pilot_rod_assembly::step_01","metal_rod"]; confidence=1.0
- N10 [Predicate] usesObject(step_01, workbench); name="usesObject"; args=["step::pilot_rod_assembly::step_01","workbench"]; confidence=1.0
- N11 [Predicate] hasTimeWindow(step_01, 0, 15); name="hasTimeWindow"; args=["step::pilot_rod_assembly::step_01",0,15]; confidence=1.0
- N12 [Rule] effect_observed_pilot_condition; rule_id="effect_observed_pilot_condition"
- N13 [Source] manual_expert_annotation:rod_assembly_steps.json
- N14 [Source] manual_symbolic_annotation:rod_assembly_steps.json
- N15 [Step] [CURRENT] Step 1 [accepted]; step_id="step::pilot_rod_assembly::step_01"; action_description="The operator places a long metal rod on the workbench."; status="accepted"; confidence=1.0; warning_count=0
- N16 [Step] Step 2 [accepted]; step_id="step::pilot_rod_assembly::step_02"; action_description="The operator slides a combination of long, short and copper sleeves onto the rod."; status="accepted"; confidence=1.0; warning_count=0
Edges:
- N16<Step:step::pilot_rod_assembly::step_02> -[DEPENDS_ON]-> N15<Step:step::pilot_rod_assembly::step_01>; required_condition={"args":["metal_rod","workbench"],"name":"secured"}; supporting_effect={"condition":{"args":["metal_rod","workbench"],"name":"secured"},"producer_status":"accepted","provisional":false,"step_id":"step::pilot_rod_assembly::step_01","type":"previous_produced_effect"}; confidence=1.0; provisional=false
- N1 -[DERIVED_FROM]-> N12
- N2 -[DERIVED_FROM]-> N12
- N6 -[DERIVED_FROM]-> N14
- N7 -[DERIVED_FROM]-> N14
- N8 -[DERIVED_FROM]-> N13
- N9 -[DERIVED_FROM]-> N14
- N10 -[DERIVED_FROM]-> N14
- N11 -[DERIVED_FROM]-> N14
- N15 -[HAS_CONSTRAINT]-> N1
- N15 -[HAS_CONSTRAINT]-> N2
- N1 -[HAS_ENTITY]-> N4
- N1 -[HAS_ENTITY]-> N5
- N2 -[HAS_ENTITY]-> N4
- N2 -[HAS_ENTITY]-> N5
...
- N9 -[HAS_ENTITY]-> N4
- N10 -[HAS_ENTITY]-> N5
- N15 -[HAS_PREDICATE]-> N6
- N15 -[HAS_PREDICATE]-> N7
- N15 -[HAS_PREDICATE]-> N8
- N15 -[HAS_PREDICATE]-> N9
- N15 -[HAS_PREDICATE]-> N10
- N15 -[HAS_PREDICATE]-> N11
- N15<Step:step::pilot_rod_assembly::step_01> -[NEXT]-> N16<Step:step::pilot_rod_assembly::step_02>
- N15 -[PRODUCES]-> N1
- N15 -[PRODUCES]-> N2
- N3 -[SUPPORTED_BY]-> N2
- N15 -[USES]-> N4
